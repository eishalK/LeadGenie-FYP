...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // FIX: Redirect new signups to step-by-step onboarding feature selection module
      navigate("/onboarding");
    } catch (error) {
  ...
  const inputBaseClasses =
    "w-full border border-white/10 rounded-xl py-3.5 pl-10 pr-4 text-base outline-none transition-all duration-300";
        ...
        <div className="hidden md:flex flex-col p-14 bg-gradient-to-br from-purple-900/30 to-transparent border-r border-white/10">
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-md">
              Create an account to unlock advanced AI tools designed to
        ...
        <div className="flex flex-col justify-center p-12 md:p-16 bg-[#0d071f]/40">
          <div className="mb-10">
            ...
            <p className="text-gray-400 text-sm">
              Join LeadGenie today and start growing.
            </p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-orange-600 hover:bg-orange-500 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-3 text-base shadow-xl shadow-orange-600/20 transition-all active:scale-[0.98] mt-6"
            >
